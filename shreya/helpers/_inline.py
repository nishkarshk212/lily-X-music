...
from shreya import app, config, lang
from shreya.core.lang import lang_codes
...
class Inline:
    ...
    def settings_markup(
        self, lang: dict, admin_only: bool, cmd_delete: bool, skip_mode: bool, language: str, chat_id: int
    ) -> types.InlineKeyboardMarkup:
        return self.ikm(
            [
                [
                ...
                [
                    ...
                    self.ikb(text=skip_mode, callback_data="settings skip"),
                ],
                [
                    self.ikb(
