...
from shreya.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("shreya/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("shreya/helpers/Inter-Light.ttf", 30)
    ...
    async def generate(self, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            # 3. Draw Text
            # Title
            title_font = ImageFont.truetype("shreya/helpers/Raleway-Bold.ttf", 45)
            ...
            # Channel and Views
            info_font = ImageFont.truetype("shreya/helpers/Inter-Light.ttf", 30)
            ...
            # 5. Time indicators
            time_font = ImageFont.truetype("shreya/helpers/Inter-Light.ttf", 25)
