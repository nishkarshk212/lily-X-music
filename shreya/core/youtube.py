...
from shreya.helpers import Track, utils
...
class YouTube:
    def __init__(self):
        ...
        self.cookies = []
        self.checked = False
        self.cookie_dir = "shreya/cookies"
        self.warned = False
        ...
        async with aiohttp.ClientSession(
            ...
            for url in urls:
                ...
                if "batbin.me" in url:
                    ...
                    link = f"https://pastebin.com/raw/{name}"
                else:
                    continue
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                try:
                    ...
                    if "Sign in to confirm your age" in str(e):
                        logger.error(f"Age restricted video detected: {video_id}. Cookies are required.")
                    else:
